...
void solve(){
  ...
  // Buscar el primer cambio significativo en los bits
  ...
  // Si no encontramos un cambio significativo, usamos un caso trivial
  if (l1 == -1) {
      l1 = n - 1;
      r1 = n;
      l2 = n - 1;
  ...
  cout << to_string(l1) << " " << to_string(r1) << " " << to_string(l2) << " " << to_string(r2) << endl;
}
